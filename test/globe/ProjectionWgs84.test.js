            ...
            it("computes the Cartesian normal at reference geographic coordinates", function () {
                ...
                for (var name in wgs84ReferenceStations) {
                    if (wgs84ReferenceStations.hasOwnProperty(name)) {
                        ...
                        var result = wgs84.surfaceNormalAtLocation(globe, pos.latitude, pos.longitude, new Vec3());
            ...
            it("computes Cartesian normals that are orthogonal to Cartesian tangents", function () {
                ...
                for (var name in wgs84ReferenceStations) {
                    if (wgs84ReferenceStations.hasOwnProperty(name)) {
                        ...
                        var normalResult = wgs84.surfaceNormalAtLocation(globe, pos.latitude, pos.longitude, new Vec3());
                        var tangentResult = wgs84.northTangentAtLocation(globe, pos.latitude, pos.longitude, new Vec3());
            ...
            it("computes Cartesian normals that are co-linear with the direction of altitude", function () {
                ...
                for (var name in wgs84ReferenceStations) {
                    if (wgs84ReferenceStations.hasOwnProperty(name)) {
                        ...
                        var normalResult = wgs84.surfaceNormalAtLocation(globe, pos.latitude, pos.longitude, new Vec3());
                        var point1 = wgs84.geographicToCartesian(globe, pos.latitude, pos.longitude, pos.altitude, null, new Vec3());
                        var point2 = wgs84.geographicToCartesian(globe, pos.latitude, pos.longitude, pos.altitude + 1, null, new Vec3());
