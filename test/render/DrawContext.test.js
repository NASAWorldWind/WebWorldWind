...
define([
    ...
    'src/WorldWind',
    'src/WorldWindow'
], function (BasicWorldWindowController, DrawContext, EarthElevationModel, Globe, LookAt, Matrix, LookAtNavigator, Plane, Rectangle, Vec2, Vec3, WorldWind, WorldWindow) {
    "use strict";
