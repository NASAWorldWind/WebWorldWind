**Important notice:** Official NASA WorldWind development is suspended, beginning April 5th, 2019. More information in the following link:
...
* Run JSDoc and review the results prior to checking in any code. It's a convenient check on documentation and typing (see _Building_ section of [README.md](../README.md) in the source repository).
