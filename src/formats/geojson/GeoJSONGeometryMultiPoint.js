...
define([
    ...
    function (
        ...
        /**
         * Constructs a GeoJSON geometry for a MultiPoint. Applications typically do not call this constructor. It is called by
         ...
         * @throws {ArgumentError} If the specified coordinates or type are null or undefined or if the coordinates parameter is not an array of positions.
         */
        var GeoJSONGeometryMultiPoint = function (coordinates, type, crs) {
