...
define([
    ...
    function (ArgumentError,
         ...
         * {@link ShapeEditor} during the shape editing process.
         * @alias ControlPointMarker
         * @constructor
         * @classdesc A visual marker with position and purpose, used by {@link ShapeEditor} during the shape editing.
