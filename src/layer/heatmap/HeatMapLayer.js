...
define([
     ...
     *  will be generated.
     * @param {Number} opacity Optional. The final opacity of this layer. Number between 0 and 1. If the opacity isn't
     *  provided the final opacity will respect the Black and white opacity generated by the layer.
     */
    var HeatMapLayer = function (displayName, measuredLocations, amountOfLevels, opacity) {
        this.tileWidth = 256;
        this.tileHeight = 256;
