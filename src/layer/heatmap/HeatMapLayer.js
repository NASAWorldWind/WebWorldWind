...
define([
    ...
    Object.defineProperties(HeatMapLayer.prototype, {
        ...
        /**
         * The final opacity of this layer. Number between 0 and 1. If the opacity isn't
         *  provided the final opacity will respect the Black and white opacity generated by the layer.
         * @memberof HeatMapLayer.prototype
         * @type {Number}
         */
        opacity: {
