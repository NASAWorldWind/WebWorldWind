...
requirejs(['./WorldWindShim'], function () {
    ...
    // Create the shared shape layer and imagery layer, as well as the logo layer.
    var pathLayer = makePathLayer(),
        ...
        logoLayer = new WorldWind.WorldWindLogoLayer();
