...
requirejs(['../src/WorldWind',
    ...
    function (WorldWind,
        ...
        var treeVisibility = new KmlTreeVisibility('treeControls', wwd);

        var kmlFile;
        var kmlFileOptions = {
            url: 'Sentinel-1-MP_17122015-16012016.kml',
            controls: [treeVisibility, timeControl]
        };
        var kmlFilePromise = new KmlFile(kmlFileOptions);
        kmlFilePromise.then(function (pKmlFile) {
            kmlFile = pKmlFile;
            kmlFile.update({layer: renderableLayer, controls: [treeVisibility, timeControl]});
        });
    });